...
function koi_ria_register_acf_fields(): void {
    ...
    acf_add_local_field_group([
        ...
        'fields'   => [
            ...
            [
                ...
                'default_value' => '',
                'allow_null'    => 1,
                'instructions'  => '毎週の放送曜日。設定すると「今週の放送」に表示されます。配信のみの番組は空欄のままにしてください。',
            ],
            [
                'key'           => 'field_show_broadcast_time',
                'label'         => '放送時間',
                'name'          => 'broadcast_time',
                'type'          => 'text',
                'default_value' => '',
                'instructions'  => '例: 21:00、22:00。放送曜日と合わせて設定してください。',
            ],
            [
    ...
    acf_add_local_field_group([
        ...
        'fields'   => [
            ...
            [
                ...
                'return_format'  => 'Y-m-d',
                'instructions' => '配信/放送開始日（YYYY-MM-DD）',
            ],
            [
                ...
                'display_format' => 'Y-m-d',
                'return_format'  => 'Y-m-d',
                'instructions' => '空欄＝放送中/配信中として扱います',
            ],
        ],
        'location' => [
            [
    ...
    acf_add_local_field_group([
        ...
        'fields'   => [
            ...
            [
                ...
                'max'           => 250,
                'append'        => 'cm',
                'instructions'  => '身長（cm）。空欄可',
            ],
            [
                'key'           => 'field_cast_is_continuation',
                'label'         => '継続メンバー',
                'name'          => 'is_continuation',
                'type'          => 'true_false',
                'default_value' => 0,
                'ui'            => 1,
                'instructions'  => '前シーズンからの継続メンバーの場合はON',
            ],
            [
                'key'          => 'field_cast_note',
                'label'        => '備考',
    ...
    acf_add_local_field_group([
        ...
        'fields'   => [
            ...
            [
                'key'          => 'field_relation_as_of_episode',
                'label'        => '時点（話数）',
                'name'         => 'as_of_episode',
                'type'         => 'number',
                'min'          => 1,
                'instructions' => 'この関係が確認された話数',
            ],
        ],
        'location' => [
            [
