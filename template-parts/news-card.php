...
<a href="<?php echo esc_url(get_permalink($post)); ?>" class="news-card">
    <div class="news-card__body">
        ...
        <time class="news-card__time" datetime="<?php echo esc_attr(get_the_date('c', $post)); ?>"><?php echo esc_html(human_time_diff(get_the_time('U', $post), current_time('timestamp'))); ?>前</time>
    </div>
